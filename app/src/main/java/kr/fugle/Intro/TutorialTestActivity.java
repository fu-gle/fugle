...
public class TutorialTestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(TutorialTestActivity.this, "Fab Clicked!", Toast.LENGTH_LONG).show();
            }
        });
    ...
    @Override
    public void onClick(View view) {
        PreferencesManager mPreferencesManager = new PreferencesManager(TutorialTestActivity.this);
